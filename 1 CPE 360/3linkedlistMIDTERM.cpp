...
class LinkedList {
    ...
    //EXTRA FUNCTIONS FROM THE MIDTERM EXAM
    ...
    void reverseList() {
        Chunk *current = head;
        Chunk *prev = NULL, *next = NULL;
        while(current != NULL) {
            //store next
            next = current ->next;
            //reverse the current Chunk's ponter
            current->next = prev;
...
int main() {
    ...
    while(1) {
        ...
        cout << "Press 5 to find and delete a value from the linked list" << endl;
        cout << "Press 6 to reverse the Linked List" << endl;
        cout << "Press 7 to delete the entire Linked List" << endl;
